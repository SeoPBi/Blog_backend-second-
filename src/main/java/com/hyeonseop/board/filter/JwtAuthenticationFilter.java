package com.hyeonseop.board.filter;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    // Request가 들어왔을 때 Request Header의 Authoriztion 필드의 Bearer Token을 가져옴
    ...
    // Request Header의 Authoriztion 필드의 Bearer Token을 가져오는 메서드
